...
?>
<div class="jumbotron">
  <h1 class="display-4">Преподаватель, приветствую!</h1>
  <p class="lead">Здесь Вы можете редактировать записи сайте.</p>
  <p class="lead">Добавлять новые уроки, редактировать их.</p>
